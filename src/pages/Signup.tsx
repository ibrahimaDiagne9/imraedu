...
const perks = [
  'Access 500+ free world-class courses',
      ...
      <div style={{
        ...
        <div className="animate-fade-in" style={{ width: '100%', maxWidth: '420px' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '1.5rem' }}>
            ...
            <span style={{ fontSize: '0.8rem', color: 'var(--text-tertiary)', fontWeight: 500 }}>or sign up with email</span>
            <div style={{ flex: 1, height: '1px', backgroundColor: 'var(--border-light)' }} />
          </div>
          ...
          <form style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }} onSubmit={handleSignup}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.75rem' }}>
              ...
              <div>
                ...
                <div style={{ position: 'relative' }}>
                  <span style={{ position: 'absolute', left: '1rem', top: '50%', transform: 'translateY(-50%)', color: 'var(--text-tertiary)', fontSize: '0.95rem', pointerEvents: 'none' }}>@</span>
                  <input type="text" placeholder="johndoe" value={form.username} required onChange={set('username')} style={inputStyle} onFocus={focusInput} onBlur={blurInput} />
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div style={{ position: 'relative' }}>
                ...
                <input
                  type={showPassword ? 'text' : 'password'} placeholder="Create a strong password" value={form.password} required
                  onChange={set('password')} style={{ ...inputStyle, paddingRight: '3rem' }} onFocus={focusInput} onBlur={blurInput}
                />
            ...
            <p style={{ fontSize: '0.78rem', color: 'var(--text-tertiary)', lineHeight: 1.5 }}>
              ...
              <Link to="#" style={{ color: 'var(--brand-blue)', fontWeight: 600 }}>Terms of Use</Link> and{' '}
      ...
      <div className="hide-on-mobile" style={{
        ...
        <div className="animate-fade-in" style={{ maxWidth: '400px', position: 'relative', zIndex: 1 }}>
          ...
          <h2 style={{ color: 'white', fontSize: '2.25rem', fontWeight: 800, lineHeight: 1.2, marginBottom: '1rem', letterSpacing: '-0.02em' }}>
            Education should be a <span style={{ color: '#6ee7b7' }}>right</span>
          </h2>
          <p style={{ color: 'rgba(255,255,255,0.75)', fontSize: '1.05rem', lineHeight: 1.65, marginBottom: '2.5rem' }}>
            Join millions of learners worldwide getting free access to world-class education — no credit card required.
          </p>

          <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            {perks.map((perk) => (
              <div key={perk} style={{ display: 'flex', alignItems: 'center', gap: '0.875rem' }}>
                <div style={{
                ...
                <span style={{ color: 'rgba(255,255,255,0.9)', fontSize: '0.95rem', fontWeight: 500 }}>{perk}</span>
              </div>
            ))}
          </div>
        </div>
