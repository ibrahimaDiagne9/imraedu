      ...
      <div className="w-full max-w-4xl">
        ...
        <div ref={certificateRef} style={{
          ...
          <div style={{
            ...
            <div className="flex flex-col items-center justify-center mb-sm gap-sm relative z-10">
              <img src="/image/IMRAEDU.png" width="160" height="auto" alt="ImraEdu Logo" />
            </div>

            <div className="text-center relative z-10 flex-1 flex flex-col justify-center">
              <h2 className="text-tertiary tracking-[0.3em] uppercase mb-sm" style={{ fontSize: '0.85rem', fontWeight: 600, color: 'var(--brand-blue)' }}>Certificate of Completion</h2>

              <p className="text-body-large text-secondary mb-0" style={{ fontStyle: 'italic' }}>This is to proudly certify that</p>
              
              <h1 className="mb-sm font-serif" style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: '2.5rem', color: '#111827', borderBottom: '2px solid var(--brand-blue)', display: 'inline-block', padding: '0 2rem', paddingBottom: '0.25rem' }}>
                {displayName}
              </h1>

              <p className="text-body-large text-secondary mb-0 mt-xs" style={{ fontStyle: 'italic' }}>has successfully completed the comprehensive course</p>
              
              <h2 className="mb-sm font-serif" style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: '2rem', color: 'var(--brand-blue)' }}>
                {courseTitle}
              </h2>
            </div>
            ...
            <div className="grid grid-cols-3 gap-xl mt-auto text-center relative z-10 items-end px-xl">
              <div>
                <div style={{ fontFamily: "'Brush Script MT', 'Dancing Script', cursive", fontSize: '1.75rem', color: '#1f2937', marginBottom: '0.25rem', borderBottom: '1px solid #d1d5db', paddingBottom: '0.25rem' }}>
                  {instructorName}
                </div>
              ...
              <div className="flex flex-col items-center justify-end">
                <div style={{ backgroundColor: 'var(--brand-blue)', color: 'white', padding: '0.75rem', borderRadius: '50%', display: 'inline-flex', boxShadow: '0 4px 14px rgba(0,0,0,0.2)', marginBottom: '0.5rem' }}>
                  <Award size={32} />
                </div>
                <p className="text-xs text-tertiary" style={{ fontSize: '0.7rem' }}>Verify at: imraedu.com/verify/{id || 'cert'}</p>
              </div>

              <div>
                <div style={{ fontSize: '1.1rem', color: '#1f2937', marginBottom: '0.25rem', borderBottom: '1px solid #d1d5db', paddingBottom: '0.75rem' }}>
